 ...
 * File: game-state-connecting-types.ts
 * Path: src/app/state/types/connecting_types/
 * Author: alexeygara
 * Last modified: 2026-02-24 18:54
 */
...
export type StateId = typeof AppSTATEid.GAME_MODE;
...
export type SceneId = typeof AppSceneID.GAME;
