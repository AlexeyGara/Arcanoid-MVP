 ...
 * File: mainmenu-state-connecting-types.ts
 * Path: src/app/state/types/connecting_types/
 * Author: alexeygara
 * Last modified: 2026-02-24 18:46
 */
...
export type StateId = typeof AppSTATEid.MAIN_MENU;
...
export type SceneId = typeof AppSceneID.MENU;
...
export type Title_View = typeof AppSceneViews[SceneId]['title_view'];
export type UI_View = typeof AppSceneViews[SceneId]['ui_view'];
export type Service_View = typeof AppSceneViews[SceneId]['service_view'];
